...
p = ggplot(df_grouped, aes(x=auroc_timeSlice_mean, fill=TrialType)) + 
  ...
  annotate("text", x=c(0.2, 0.8), y=c(20, 20), label=paste(round(hit_values, 0), '%', sep=''), color=TRIALTYPE_MODULATION_COLORS[1], size=7) + 
  annotate("text", x=c(0.2, 0.8), y=c(18, 18), label=paste(round(fa_values, 0), '%', sep=''), color=TRIALTYPE_MODULATION_COLORS[2], size=7) + 
...
p = ggplot(df_grouped, aes(x=auroc_timeSlice_mean, fill=TrialType)) + 
  ...
  annotate("text", x=c(0.2, 0.8), y=c(20, 20), label=paste(round(hit_values, 0), '%', sep=''), color=TRIALTYPE_MODULATION_COLORS[1], size=7) + 
  annotate("text", x=c(0.2, 0.8), y=c(18, 18), label=paste(round(fa_values, 0), '%', sep=''), color=TRIALTYPE_MODULATION_COLORS[2], size=7) + 
  annotate("text", x=c(0.2, 0.8), y=c(16, 16), label=paste(round(miss_values, 0), '%', sep=''), color=TRIALTYPE_MODULATION_COLORS[3], size=7) + 
...
# Fig S1G heatmaps were generated using Python.
